...
export class PrivacyPolicyComponent implements OnInit {
  ...
  public privacyList = [
        ...
        },
        {
          ...
          faqs: [
            ...
            },
            {
              ...
              ans: "No, We don't share the raw data with third parties. The clients only have view access to the data using GetCurious’s SaaS platform. They can’t export the videos outside the platform. Clients can only access these videos till they are under the Non disclosure agreement."
            },
          ]
        }
      ]
    },
    {
      ...
      desc: '‍These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with https://GetCurioushq.com website (the "Service") operated by UXR Labs Inc ("us", "we", or "our").',
      enum: 'tnc',
      class: 'tnc',
      array: [
        {
    ...
    },
    {
      ...
      desc: 'These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with https://getcurious.io website (the "Service") operated by UXR Labs Inc ("us", "we", or "our").',
      enum: 'tnc4p',
      class: 'tnc',
      array: [
        {
        ...
        {
          title: "Registration",
          desc: "In order to function as a tester for GetCurious, you may need to download a software application (“GetCurious Recorder”) from our website, GetCurioushq (the “Website”), which will provide you with access to our testing platform, and you may also need to download other SW languages or applications if they are not already installed on your computer. By downloading the GetCurious Recorder, you hereby authorize GetCurious to access the computer on which you download the GetCurious Recorder for the express purpose of and to the extent required for your participating as a tester in the qualitative research testing services. You agree to assume full responsibility for any damage caused to your system, any programs, data or information related to or arising from such downloads or the testing services you provide.When you sign up with GetCurious to act as a tester, GetCurious will, through the registration process, collect personally identifiable information about you such as your name, contact information, PayPal account information, race, age, gender, education, employment status and hobbies, and any other information that we request and that you provide, either initially or in follow up questionnaires after registration. You agree to the collection and use of such personally identifiable information, including video images of your face and audio recordings of your voice as part of providing usability testing services. You hereby irrevocably transmit to GetCurious the exclusive and full copyright ownership of such video and audio recordings. You represent that the information you provide to GetCurious will be authentic, accurate and complete and made in accordance with GetCurious policies and procedures.In addition, GetCurious may collect details of your visits to the Websites or software we ask you to test, including, but not limited to, clickflow, traffic data, location data, weblogs, operating system, browser type, for the purpose of system administration and fraud prevention."
        },
        {
          title: "Rewards",
          desc: "Upon completing a Test, you may be entitled to receive a payment, a gift card, points or other rewards (“Rewards”). In advance of each Test, you will be informed through the Platform or directly if completion of the Test entitles you to a Reward.You are responsible for determining any tax liabilities incurred as a result of receiving a Reward. Occasionally, a Customer may offer to provide a Reward to you for completing a Test it developed. If a Customer makes such an offer, then you shall receive the Reward directly from that Customer, and you acknowledge and agree that GetCurious has no obligation with respect to such Reward.Any participant who engages in any of the Restricted Activities set out below shall not be entitled to receive a Reward."
        },
        {
          title: null,
          desc: null,
        ...
        {
          title: 'Indemnity',
          desc: 'You agree to indemnify and hold harmless GetCurious, its employees, suppliers and licensors, their respective officers, directors, employees, agents, subsidiaries and affiliates, and each of them from any third-party claim, liability, loss, damage, cost or expense (including without limitation reasonable attorney’s fees) arising out of or related to your provision of testing services, the Website or any Content it contains; your failure to comply with these Terms of Use; your infringement, violation, or misappropriation of any third party rights; or any violation of applicable laws or regulations.',
        },
        {
          title: 'General Terms and Conditions',
          desc: 'Participants "You" and GetCurious are independent parties. Nothing in these Terms of Use will be construed to make You an agent, employee, joint venturer, partner or legal representative of GetCurious. These Terms of Use constitute the entire agreement between the parties relating to the subject matter herein, and shall completely replace any prior agreements, oral or written, between you and GetCurious in relation to you acting as a tester for GetCurious. You agree that if GetCurious does not exercise or enforce any legal right or remedy which is contained in these Terms of Use (or which GetCurious has the benefit of under any applicable law), this will not constitute a formal waiver of GetCurious ´rights and those rights or remedies will still be available to GetCurious. You may not assign or delegate any rights or obligations under these Terms of Use and any purported assignment or delegation shall be ineffective. GetCurious may freely assign or delegate all rights and obligations under these Terms of Use, fully or partially. These terms of use shall be governed by the law of the State of Delaware, USA. You hereby consent to the jurisdiction of the state and federal courts in and for Delaware, USA, for the resolution of any dispute arising out of or related to these Terms of Use. If any court of law, having jurisdiction over the Website and/or the qualitative research testing services, rules that any provision of these Terms of Use is invalid, unlawful, void or for any reason unenforceable, then that provision shall be deemed severable from these Terms of Use and shall not affect the rest of these Terms of Use, which shall continue in full force and effect.',
        }
      ]
    }
  ]
