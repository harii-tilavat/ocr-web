...
import { BlogDescriptionModel, BlogDetailResponseModel, BlogHeadingModel, GenericResponseList, MoreStoryModel, ResourceResponseModel } from 'src/app/_model';
        ...
        next: (res: GenericResponseList<ResourceResponseModel>) => {
          if (res && res.data) {
            if (res.data.resourceDetails) {
              ...
              this.resourceHeading = { ...this.resourceHeading, title: this.resourceDetails.title, image: this.resourceDetails.poster_image, metadata: this.resourceDetails.metadata };
            }
