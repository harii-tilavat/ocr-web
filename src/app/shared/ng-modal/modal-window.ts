...
import { getFocusableBoundaryElements, Key } from './focus-trap';
import { ModalDismissReasons } from './modal-dismiss-reasons';
import { ngbRunTransition, NgbTransitionOptions } from './ngbTransition';
import { isString, reflow } from './util';
...
export class NgbModalWindow implements OnInit,
  ...
  @ViewChild('dialog', { static: true }) private _dialogEl: ElementRef<HTMLElement> | undefined;
  ...
  private _restoreFocus() {
    ...
    const elWithFocus = this._elWithFocus as any;
